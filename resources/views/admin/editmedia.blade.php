...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" method="post" action="{{ route('updatemedia', ['id' => $editmedia->id]) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class=" d-flex justify-content-between">
                  ...
                  <input type="text" class="form-control" name="titlename" value="{{ $editmedia->titlename }}" id="exampleInputName1" placeholder="Enter Title">
                </div>
                <div class="form-group">
                  <label for="exampleInputName1" class="block uppercase tracking-wide text-white text-xs font-bold mb-2">Automated Slug</label>
                  <input type="text" class="form-control" name="autometedslug" value="{{ $editmedia->autometedslug }}"  id="exampleInputName1" placeholder="Automated Slug">
                </div>
                <div class="form-group">
                ...
                <div style="width:38%; padding:10px;" class="bg-blue-950">
                    ...
                    <div class="row" style="padding:20px;">
                      ...
                      <input class="form-check-input" type="radio" name="quality" {{ $editmedia->quality === 'hdquality' ? 'checked' : '' }} id="hdquality" value="hdquality">
                ...
                padding-left: 10px;">
                      <input class="form-check-input" type="radio" name="quality" {{ $editmedia->quality === 'Normal' ? 'checked' : '' }} id="Normal" value="Normal">
                    ...
                    <div class="row" style="padding:20px;">
                      ...
                      <div class="form-check form-check-inline border border-success bg-light" style="width:100px; padding-left:10px; margin-left:10px;">
                      <input class="form-check-input" type="radio" name="Featured" {{ $editmedia->Featured === 'Yes' ? 'checked' : '' }} id="yesfetured" value="yes">
                      <label for="yesfetured" style="margin-top: 0.5rem;">yes</label>
                    </div>
                    <div class="form-check form-check-inline border border-success bg-light" style="    padding-right: 10px;
                padding-left: 10px;">
                      <input class="form-check-input" type="radio" name="Featured" {{ $editmedia->Featured === 'No' ? 'checked' : '' }} id="nofetured" value="No">
                      ...
                      <div class="form-check form-check-inline border border-success bg-light" style="width:100px; padding-left:10px; margin-left:10px;">
                      <input class="form-check-input" type="radio" name="Watermarked" {{ $editmedia->Watermarked === 'Yes' ? 'checked' : '' }} id="Watermarked" value="Yes">
                      <label for="Watermarked" style="margin-top: 0.5rem;">Yes</label>
                    </div>
                    <div class="form-check form-check-inline border border-success bg-light" style="    padding-right: 10px;
                padding-left: 10px;">
                      <input class="form-check-input" type="radio" name="Watermarked" {{ $editmedia->Watermarked === 'No' ? 'checked' : '' }} id="Watermarked1" value="No">
          ...
          <div class="form-group">
            ...
            <select id="disabledSelect" name="author" value="{{ $editmedia->author }}" class="form-control">
          ...
          <div class="form-group">
            ...
            <select id="disabledSelect" name="status" value="{{ $editmedia->status }}" class="form-control">
