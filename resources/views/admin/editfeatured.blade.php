...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" method="post" action="{{ route('updatefeatured', ['id' => $editfeatured->id]) }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $editfeatured->id }}">
                <div class=" d-flex justify-content-between">
                  ...
                  <input type="text" class="form-control" name="adviser_name" id="exampleInputName1" value="{{ $editfeatured->adviser_name }}" placeholder="Advisor Name">
                </div>
                <div class="form-group  px-3">
                  <label for="exampleInputName1" class="block uppercase tracking-wide text-white text-xs font-bold mb-2">Designation</label>
                  <input type="text" class="form-control" name="designation"  id="exampleInputName1" value="{{ $editfeatured->designation }}" placeholder="Designation">
                </div>
          ...
          <div class="form-group">
            ...
            <select id="disabledSelect" name="status" value="{{ $editfeatured->status }}" class="form-control">
